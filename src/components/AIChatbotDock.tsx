  ...
  return (
    <div className="absolute bottom-4 right-4 z-40">
      ...
      {!isMinimized && (
        <DraggablePanel
          id="ai-chat-dock"
          defaultPosition={{ x: -396, y: -520 }} // bottom-right of chart
          defaultSize={{ width: 380, height: 520 }}
          bounds={getChartBounds()}
          className="z-40"
        >
          <Card className="w-full h-full bg-slate-950/95 border-slate-800/50 backdrop-blur-xl shadow-2xl flex flex-col">
          {/* Drag Handle Header */}
          <div className="px-4 py-2 border-b border-slate-800/50 flex items-center gap-2 cursor-grab active:cursor-grabbing bg-slate-800/30">
            <Move className="w-4 h-4 text-slate-400" />
            <span className="text-xs text-slate-400 font-medium">AI Trading Assistant</span>
          ...
          <div className="p-4 border-b border-slate-800/50 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="text-xs text-slate-400">Drag to move</div>
            </div>
          </div>
